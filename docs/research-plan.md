...
| G3 Baselines | B0–B3 with locked splits and confidence intervals | Split frozen; B0–B3 calibration completed privately; paired whole-match calibration uncertainty command available; final test pending |
